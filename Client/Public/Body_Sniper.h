...
class CBody_Sniper final : public CPartObject
{
private:
	CBody_Sniper(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CBody_Sniper(const CBody_Sniper& Prototype);
	virtual ~CBody_Sniper() = default;
...
public:
	static CBody_Sniper* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
